  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 text-center">
      ...
      <p className="text-sm text-gray-500 max-w-sm mb-8">
        Ask me to explain concepts, solve problems, summarize topics, or help
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-xl">
        {SUGGESTED_PROMPTS.map(({ Icon: PromptIcon, label, prompt }) => (
          <button
            ...
            className="flex items-center gap-3 bg-white border border-gray-100 rounded-xl px-4 py-3 text-left hover:border-primary-200 hover:bg-primary-50 transition-all shadow-sm group">
